  ...
  <div className="flex flex-col justify-center">
    ...
    <div className="mt-10 border-t border-slate-800 pt-8">
      ...
      <p className="mt-4 text-lg leading-8 text-slate-400">
        I&apos;m an outgoing person who enjoys spending time with friends and
        exploring new places around Montreal. Music is a big part of my life —
        I play drums and listen to hip-hop, rock, R&amp;B, and indie music.
      </p>
      ...
      <p className="mt-5 text-lg leading-8 text-slate-400">
        Outside of that, I love discovering cafés, and one of my personal goals
        is to explore as many cafés in Montreal as possible.
      </p>
    ...
    >
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="max-w-3xl">
          ...
          <p className="mt-5 text-lg leading-8 text-slate-400">
            My academic journey across software engineering, mathematics, physics,
        ...
        <div className="mt-14 space-y-8">
          {/* McGill */}
          <article className="rounded-2xl border border-slate-800 bg-slate-900 p-7 md:p-8">
            ...
            <div className="mt-7 grid gap-8 md:grid-cols-[1.5fr_1fr]">
              <div>
                <ul className="space-y-4 leading-7 text-slate-400">
                  <li>
                    • Hugh Brock Scholarship recipient.
                  </li>

                  <li>
                    • Coursework includes Object-Oriented Programming,
                    Algorithms & Data Structures, Software Testing, and Agile
                    development.
                  </li>
            ...
            <div className="mt-7 grid gap-8 md:grid-cols-[1.5fr_1fr]">
              <div>
                <ul className="space-y-4 leading-7 text-slate-400">
                  ...
                  <li>
                    • Achieved 3 A* grades in Mathematics, Physics, and Chemistry,
                    plus an A in Further Mathematics.
                  </li>
                  ...
                  <li>
                    • Participated in student volunteering and school activities.
                  </li>
                </ul>
              </div>
    ...
    >
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="max-w-3xl">
          ...
          <p className="mt-5 text-lg leading-8 text-slate-400">
            Practical software engineering experience across full-stack development,
            enterprise systems, hardware integration, testing, and automation.
          </p>
        </div>
        ...
        <div className="mt-14 space-y-10">
          {/* Eastcompeace */}
          <article className="relative rounded-2xl border border-slate-800 bg-slate-900 p-7 md:p-8">
            <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
              <div>
                <p className="text-sm font-semibold text-blue-400">
                  May 2026 – Aug 2026
            ...
            <div className="mt-7 grid gap-8 md:grid-cols-[1.5fr_1fr]">
              <div>
                <ul className="space-y-4 leading-7 text-slate-400">
                  <li>
                    • Developed a full-stack Meal Ticket Management System using
                    Java, Spring Boot, React, TypeScript, MySQL, and REST APIs.
                  </li>

                  <li>
                    • Integrated physical smart-card readers with the web
                    application for real-time employee identification and ticket
                    confirmation.
                  </li>

                  <li>
                    • Diagnosed and resolved issues across frontend, backend,
                    database, network, and hardware components through integration
                    and end-to-end testing.
                  </li>

                  <li>
                    • Translated business requirements and supervisor feedback into
          ...
          <article className="relative rounded-2xl border border-slate-800 bg-slate-900 p-7 md:p-8">
            ...
            <div className="mt-7 grid gap-8 md:grid-cols-[1.5fr_1fr]">
              <div>
                <ul className="space-y-4 leading-7 text-slate-400">
                  <li>
                    • Enhanced Java-based ERP functionality integrated with Oracle
                    systems to support internal business workflows.
                  </li>

                  <li>
                    • Worked with enterprise data and internal process automation.
                  </li>

                  <li>
                    • Automated Excel file classification and report generation
                    through AI-assisted scripting.
                  </li>

                  <li>
                    • Helped reduce repetitive manual processing through automation
...
<div className="pt-6">
  ...
  <p className="mt-4 max-w-3xl leading-7 text-slate-400">
    Roles that strengthened my communication, teamwork, attention to detail,
    and ability to work effectively in fast-paced environments.
  </p>
</div>
...
<article className="rounded-2xl border border-slate-800 bg-slate-900 p-7 md:p-8">
  ...
  <div className="mt-7 grid gap-8 md:grid-cols-[1.5fr_1fr]">
    <div>
      <ul className="space-y-4 leading-7 text-slate-400">
        <li>
          • Developed strong interpersonal skills by interacting with hundreds
          of customers daily and communicating clearly about orders, dietary
          needs, and wait times.
        </li>

        <li>
          • Supported a high-volume restaurant team serving 300+ guests daily,
          helping ensure accurate table coordination and timely service.
        </li>

        <li>
          • Worked effectively under pressure while handling changing customer
          needs and coordinating with coworkers.
        </li>
      </ul>
    </div>
...
<article className="rounded-2xl border border-slate-800 bg-slate-900 p-7 md:p-8">
  ...
  <div className="mt-7 grid gap-8 md:grid-cols-[1.5fr_1fr]">
    <div>
      <ul className="space-y-4 leading-7 text-slate-400">
        <li>
          • Operated specialized machinery for LED bulb processing while
          following safety procedures and maintaining production accuracy.
        </li>

        <li>
          • Conducted quality inspections to identify and remove defective or
          damaged LED components.
        </li>

        <li>
          • Collaborated with coworkers and supervisors to maintain a smooth
          workflow in a fast-paced production environment.
        </li>
      </ul>
    </div>
